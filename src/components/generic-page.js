  ...
  return (
    <div sx={{marginTop: ['5.5rem', '5.5rem', '7rem']}}>
      {headerImage && headerImage && (
        <div sx={{
          paddingBottom: ['calc(12 / 16 * 100%)', 'calc(10 / 16 * 100%)', 'calc(8 / 16 * 100%)', 'calc(8 / 16 * 100%)', 'calc(7/ 16 * 100%)', 'calc(6/ 16 * 100%)'],
          position: 'relative',
      ...
      <section sx={{variant: 'sections.hpSectionLight'}}>
        <Container sx={{maxWidth: '6xl', px: [2, 2, 4], py: [4, 5]}}s>
          ...
          <Flex sx={{flexWrap: 'wrap', flexDirection: 'row-reverse'}}>
            <Box sx={{width: ['full', 'full', (section === 'No Section') ? 'full' : '3/4'], pl: [0, 0, 4]}}>
              {section !== 'No Section' &&
