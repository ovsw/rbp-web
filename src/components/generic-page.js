        ...
        >
          ...
          >
            <source
              ...
              srcSet={imageUrlFor(buildImageObj(headerImage))
                .width(1920)
      ...
      {!headerImage && (
        ...
        >
          ...
          >
            <source
              media="(min-width: 1600px)"
              srcSet="https://via.placeholder.com/1920x600?text=missing+image"
            />
            <source
              media="(min-width: 1280px)"
              srcSet="https://via.placeholder.com/1600x600?text=missing+image"
            />
            <source
              media="(min-width: 640px)"
              srcSet="https://via.placeholder.com/769x288?text=missing+image"
            />
            <img
              src="https://via.placeholder.com/400x300?text=missing+image"
              alt="placeholder"
              sx={{
                display: "block",
                position: "absolute",
      ...
      <section sx={{ variant: "sections.hpSectionLight" }}>
        <Container sx={{ maxWidth: "6xl", px: [2, 2, 4], py: [4, 5] }} s>
          ...
          <Flex sx={{ flexWrap: "wrap", flexDirection: "row-reverse" }}>
            <Box
              sx={{
                width: ["full", "full", section === "No Section" ? "full" : "3/4"],
                pl: [0, 0, 4]
              }}
            >
              {section !== "No Section" && (
